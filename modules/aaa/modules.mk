...
mod_authn_alias.la: mod_authn_alias.slo
	$(SH_LINK) -rpath $(libexecdir) -module -avoid-version  mod_authn_alias.lo $(MOD_AUTHN_ALIAS_LDADD)
...
static = 
shared =  mod_authn_file.la mod_authn_dbm.la mod_authn_anon.la mod_authn_dbd.la mod_authn_default.la mod_authn_alias.la mod_authz_host.la mod_authz_groupfile.la mod_authz_user.la mod_authz_dbm.la mod_authz_owner.la mod_authz_default.la mod_auth_basic.la mod_auth_digest.la
